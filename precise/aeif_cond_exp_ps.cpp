...
nest::aeif_cond_exp_ps::Parameters_::Parameters_()
...
nest::aeif_cond_exp_ps::State_::State_( const Parameters_& p )
  : r_( 0 )
  , r_offset_( 0. )
{
  y_[ 0 ] = p.E_L;
...
nest::aeif_cond_exp_ps::State_::State_( const State_& s )
  : r_( s.r_ )
...
nest::aeif_cond_exp_ps::State_&
nest::aeif_cond_exp_ps::State_::operator=( const State_& s )
{
...
void
nest::aeif_cond_exp_ps::Parameters_::get( DictionaryDatum& d ) const
{
...
void
nest::aeif_cond_exp_ps::Parameters_::set( const DictionaryDatum& d )
{
...
void
nest::aeif_cond_exp_ps::State_::get( DictionaryDatum& d ) const
{
...
nest::aeif_cond_exp_ps::Buffers_::Buffers_( aeif_cond_exp_ps& n )
  : logger_( n )
  , s_( 0 )
  , c_( 0 )
  , e_( 0 )
...
nest::aeif_cond_exp_ps::aeif_cond_exp_ps()
  : Archiving_Node()
  , P_()
  , S_( P_ )
  , B_( *this )
...
nest::aeif_cond_exp_ps::aeif_cond_exp_ps( const aeif_cond_exp_ps& n )
  : Archiving_Node( n )
  , P_( n.P_ )
  , S_( n.S_ )
  , B_( n.B_, *this )
...
void
nest::aeif_cond_exp_ps::init_state_( const Node& proto )
{
  const aeif_cond_exp_ps& pr = downcast< aeif_cond_exp_ps >( proto );
  S_ = pr.S_;
}

void
nest::aeif_cond_exp_ps::init_buffers_()
{
  B_.events_.resize();
  B_.events_.clear();
  ...
  B_.sys_.function = aeif_cond_exp_ps_dynamics;
...
void
nest::aeif_cond_exp_ps::interpolate_( double& t, double t_old )
{
...
void
nest::aeif_cond_exp_ps::spiking_( const long T, const long lag, const double t )
{
  // spike event
...
void
nest::aeif_cond_exp_ps::handle( SpikeEvent& e )
{
...
void
nest::aeif_cond_exp_ps::handle( CurrentEvent& e )
{
  assert( e.get_delay() > 0 );
...
void
nest::aeif_cond_exp_ps::handle( DataLoggingRequest& e )
{
  B_.logger_.handle( e );
}
