...
#ifndef AEIF_COND_ALPHA_PS_H
#define AEIF_COND_ALPHA_PS_H
...
/* BeginDocumentation
Name: ps_aeif_cond_alpha - Conductance-based exponential integrate-and-fire
...
SeeAlso: iaf_cond_alpha, aeif_cond_exp, aeif_cond_alpha, aeif_cond_alpha_ps
*/
 ...
 */
extern "C" int
aeif_cond_alpha_ps_dynamics( double, const double*, double*, void* );

class aeif_cond_alpha_ps : public Archiving_Node
{
public:
  /**
  ...
  */
  aeif_cond_alpha_ps( const aeif_cond_alpha_ps& );
...
private:
  ...
  friend class RecordablesMap< aeif_cond_alpha_ps >;
  friend class UniversalDataLogger< aeif_cond_alpha_ps >;
...
public:
  ...
  */
  struct Buffers_
  {
    Buffers_( aeif_cond_alpha_ps& ); //!<Sets buffer pointers to 0
    Buffers_( const Buffers_&,
      aeif_cond_alpha_ps& ); //!<Sets buffer pointers to 0

    //! Logger for all analog data
    UniversalDataLogger< aeif_cond_alpha_ps > logger_;
  ...
  */
  ...
  static RecordablesMap< aeif_cond_alpha_ps > recordablesMap_;

  /** @} */
};

inline port
aeif_cond_alpha_ps::send_test_event( Node& target,
  port receptor_type,
  synindex,
  bool )
{
...
inline port
aeif_cond_alpha_ps::handles_test_event( SpikeEvent&, port receptor_type )
{
  // You should usually not change the code in this function.
...
inline port
aeif_cond_alpha_ps::handles_test_event( CurrentEvent&, port receptor_type )
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline port
aeif_cond_alpha_ps::handles_test_event( DataLoggingRequest& dlr,
  port receptor_type )
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void
aeif_cond_alpha_ps::get_status( DictionaryDatum& d ) const
{
...
inline void
aeif_cond_alpha_ps::set_status( const DictionaryDatum& d )
{
...
#endif /* #ifndef AEIF_COND_ALPHA_PS_H */
