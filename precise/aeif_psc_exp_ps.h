 ...
 */
extern "C" int
aeif_psc_exp_ps_dynamics( double, const double*, double*, void* );
...
inline port
aeif_psc_exp_ps::send_test_event( Node& target,
  port receptor_type,
  synindex,
  bool )
{
...
inline port
aeif_psc_exp_ps::handles_test_event( DataLoggingRequest& dlr,
  port receptor_type )
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
