...
#ifndef AEIF_PSC_ALPHA_PS_H
#define AEIF_PSC_ALPHA_PS_H
...
/* BeginDocumentation
Name: aeif_psc_alpha_ps - Current-based exponential integrate-and-fire
...
inline port
aeif_psc_alpha_ps::handles_test_event( SpikeEvent&, port receptor_type )
{
  // You should usually not change the code in this function.
...
inline port
aeif_psc_alpha_ps::handles_test_event( CurrentEvent&, port receptor_type )
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void
aeif_psc_alpha_ps::get_status( DictionaryDatum& d ) const
{
...
inline void
aeif_psc_alpha_ps::set_status( const DictionaryDatum& d )
{
...
#endif /* #ifndef AEIF_PSC_ALPHA_PS_H */
